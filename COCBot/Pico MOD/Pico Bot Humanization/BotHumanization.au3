...
Func GetReplayDuration()
	...
	Local $Result = QuickMIS("N1", @ScriptDir & "\imgxml\Resources\Pico Humanization\Duration", 380, 600, 490, 630)
...
Func VisitAPlayer()
	...
	If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\Visit") Then
	...
	If _ColorCheck(_GetPixelColor(53, 24, True), "D00818", 20) Then
		...
		If IsClanOverview() Then
			If _ColorCheck(_GetPixelColor(772, 70, True), "D00818", 20) Then
				...
				Click(700, 80)
				randomSleep(2000)
				If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\Friend", 720, 165, 780, 600) Then
					Click($g_iQuickMISX + 720, $g_iQuickMISY + 165)
					randomSleep(1500)
					If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\Friend", 440, 380, 590, 470) Then
...
Func CollectAchievements()
	...
	If _ColorCheck(_GetPixelColor(53, 24, True), "D00818", 20) Then
		...
		If IsClanOverview() Then
			If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\ClaimReward", 680) Then
