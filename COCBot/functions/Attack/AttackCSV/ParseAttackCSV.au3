							...
							If $value4 = "REMAIN" Then
								...
								If PrepareAttack($g_iMatchMode, True) > 0 Then
									For $ii = $eBarb To $eBowl ; lauch all remaining troops
										DropTroopFromINI($value1, $index1, $index2, $indexArray, 200, 200, $g_asTroopShortNames[$ii], $delaypoints1, $delaypoints2, $delaydrop1, $delaydrop2, $sleepdrop1, $sleepdrop2, $debug)
										CheckHeroesHealth()
