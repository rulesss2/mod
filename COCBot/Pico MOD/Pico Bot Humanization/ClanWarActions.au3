...
Func LookAtCurrentWar()
	...
	If IsWarMenu() Then
		If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\CurrentWar", 740, 320, 830, 420) Then
...
Func WatchWarReplays()
	...
	If QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\WarDetails", 740, 620, 850, 720) And QuickMIS("BC1", @ScriptDir & "\imgxml\Resources\Pico Humanization\CurrentWar", 740, 320, 830, 420) Then
		SetLog("Open War details menu...", $COLOR_ACTION1)
		Click(800, 670) ; go to war details
		randomSleep(1500)
		...
		If IsClanOverview() Then
			...
			If IsBestClans() Then
				Local $ReplayNumber = QuickMIS("Q1", @ScriptDir & "\imgxml\Resources\Pico Humanization\Replay", 780, 240, 840, 670)
